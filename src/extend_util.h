 ...
 * @return value:zero is success,others is error
 * */
int get_trafficCount(char *iface_name, unsigned long long *income,
		unsigned long long *outgo, unsigned int *rx_rate, unsigned int *tx_rate);
 ...
 * @return value: zero is success,others is error.
 * */
int get_unknown_client_speed(const char *client_ip, int *go_speed,
		int *come_speed);
