...
/*gaomingpan*/
#define TABLE_WIFIDOG_UNTRUSTED    "WiFiDog_$ID$_Untrusted"
/* limeng */
#define TABLE_WIFIDOG_WHITELIST    "WiFiDog_$ID$_WhiteList"
#define TABLE_WIFIDOG_BLACKLIST    "WiFiDog_$ID$_BlackList"
